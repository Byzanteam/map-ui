...
!(function (d) {
  let e,
      n = `<svg>
            <symbol id="icon-triangleDown" viewBox="0 0 1024 1024">
              <path d="M957.056 338.624C951.84 327.296 940.512 320 928 320L96 320c-12.512 0-23.84 7.296-29.088 18.624-5.216 11.36-3.328 24.704 4.768 34.208l416 485.344c6.08 7.104 14.944 11.2 24.288 11.2s18.208-4.096 24.288-11.2l416-485.344C960.448 363.328 962.272 349.984 957.056 338.624z"  ></path>
            </symbol>
            <symbol id="icon-triangle" viewBox="0 0 1024 1024">
              <path d="M952.32 715.2l-416-485.376c-12.16-14.176-36.448-14.176-48.608 0l-416 485.376c-8.128 9.472-9.984 22.848-4.768 34.176C72.16 760.704 83.488 768 96 768l832 0c12.512 0 23.84-7.296 29.056-18.624S960.448 724.672 952.32 715.2z"  ></path>
            </symbol>
    ...
    let e,
        t; (e = document.createElement('div')).innerHTML = n, n = null, (t = e.getElementsByTagName('svg')[0]) && (t.setAttribute('aria-hidden', 'true'), t.style.position = 'absolute', t.style.width = 0, t.style.height = 0, t.style.overflow = 'hidden', (function (e, t) { t.firstChild ? (function (e, t) { t.parentNode.insertBefore(e, t); }(e, t.firstChild)) : t.appendChild(e); }(t, document.body)));
  }));
}(window));
